                ...
                <div class="card">
                    ...
                    <div class="card-body pb-1">
                        <div id="lightgallery" class="row">
                            ...
                            @endif
                            @if (!empty($vendorDetails['vendor_business']['license_proof']))
                            <a href="{{ asset('storage/images/proof/'.$vendorDetails['vendor_business']['license_proof']) }}" data-exthumbimage="{{ asset('storage/images/proof/'.$vendorDetails['vendor_business']['license_proof']) }}" data-src="images/big/img1.jpg" class="col-lg-3 col-md-6 mb-4">
